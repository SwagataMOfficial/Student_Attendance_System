...
collapse_btn.addEventListener("click", () => {
  document
    .querySelector("#collapse-btn .material-symbols-outlined")
    .classList.toggle("arrow-rotate");
  document.querySelector(".container .left-nav").classList.toggle("nav-active");
  document
    .querySelector(".container .right-main")
    .classList.toggle("main-stretch");
  document
    .querySelector("#collapse-btn .collapse-name")
    .classList.toggle("btn-collapse");
